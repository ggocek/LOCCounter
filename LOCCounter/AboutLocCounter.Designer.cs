namespace LOCCounter
{
	partial class AboutLocCounter
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AboutLocCounter));
			...
			this.tableLayoutPanel.Controls.Add(this.linkCompany, 1, 3);
			...
			// linkCompany
			// 
			this.linkCompany.Dock = System.Windows.Forms.DockStyle.Fill;
			this.linkCompany.Location = new System.Drawing.Point(6, 78);
			this.linkCompany.Margin = new System.Windows.Forms.Padding(6, 0, 3, 0);
			this.linkCompany.MaximumSize = new System.Drawing.Size(0, 17);
			this.linkCompany.Name = "linkCompany";
			this.linkCompany.Size = new System.Drawing.Size(408, 17);
			this.linkCompany.TabIndex = 25;
			this.linkCompany.TabStop = true;
			this.linkCompany.Text = "gocek.org";
			this.linkCompany.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			...
			this.Name = "AboutLocCounter";
			this.Padding = new System.Windows.Forms.Padding(9);
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "AboutLocCounter";
